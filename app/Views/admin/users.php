...
<div class="flex justify-between items-center mb-4">
  ...
  <a href="/admin/users/edit/0" class="px-4 py-2 bg-green-600 text-white rounded">Créer un utilisateur</a>
</div>
  ...
  <tbody>
    ...
    <tr class="border-t">
      ...
      <td class="p-2 space-x-2">
        <a href="/admin/users/edit/<?= $u['id'] ?>" class="text-blue-600">Éditer</a>
        <form action="/admin/users/delete/<?= $u['id'] ?>" method="post" class="inline">
